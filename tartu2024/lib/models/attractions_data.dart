...
final List<Attraction> attractions = [
  ...
  // University of Tartu Museum, Tartu Cathedral, Botanical Gardens of the University of Tartu, AHHAA Science Centre, Estonian National Museum, Toome Hill Park, Tartu Toy Museum, Tartu Art Museum, Angel's Bridge, and the additional attractions
  Attraction(
  ...
  Attraction(
    ...
    imageUrl: "https://example.com/emajogi-promenade.jpg",
  ...
  Attraction(
    ...
    imageUrl: "https://example.com/tartu-city-museum.jpg",
  ...
  Attraction(
    ...
    imageUrl: "https://example.com/st-johns-church.jpg",
  ...
  Attraction(
    ...
    description:
        "Unravel the mysteries of the cosmos at Tartu Observatory, where cutting-edge research and celestial wonders converge, offering visitors a glimpse into the vast expanse of space and time.",
    imageUrl: "https://example.com/tartu-observatory.jpg",
    address: "Tõravere 61602, Tartu County, Estonia",
    visitingHours: "10:00 - 17:00, closed on Mondays",
    directions:
        "Located outside the city center, accessible by car or public transportation.",
    latitude: 58.3814, // Example latitude
    longitude: 26.7199,
    placeId: "PLACE_ID_14",
  ),
  Attraction(
    ...
    imageUrl: "https://example.com/tartu-market-square.jpg",
  ...
  Attraction(
    ...
    imageUrl: "https://example.com/estonian-sports-museum.jpg",
  ...
  Attraction(
    name: "Toy Museum \"Millenium\"",
    description:
        "Step into a whimsical world of play and imagination at the Toy Museum \"Millenium\", where vintage and modern toys delight visitors of all ages, offering a nostalgic journey through childhood memories.",
    imageUrl: "https://example.com/toy-museum-millenium.jpg",
    address: "Tartu mnt 2, 51005 Tartu, Estonia",
    visitingHours: "11:00 - 18:00, closed on Mondays and Tuesdays",
    directions:
        "Located near the city center, within walking distance from Tartu Art Museum.",
    latitude: 58.3814, // Example latitude
    longitude: 26.7199,
    placeId: "PLACE_ID_17",
  ),
  Attraction(
    ...
    imageUrl: "https://example.com/tartu-observatory-museum.jpg",
    address: "Tõravere 61602, Tartu County, Estonia",
    visitingHours: "10:00 - 17:00, closed on Mondays",
    directions:
  ...
  Attraction(
    name: "Tartu Inglisild (Angel's Bridge)",
    description:
        "Cross the threshold into a realm of timeless beauty and architectural grace, as this historic bridge connects the enchanting Toome Hill with the picturesque Old Town, offering vistas that inspire the soul.",
    imageUrl: "https://example.com/tartu-angels-bridge.jpg",
    address: "Toome Hill, Tartu, Estonia",
    visitingHours: "Open 24 hours",
    directions:
        "Crosses over Lossi Street, connecting the city center to Toome Hill.",
  ...
  Attraction(
    ...
    imageUrl: "https://example.com/tartu-cathedral-bell-tower.jpg",
    address: "Lossi 25, Tartu, Estonia",
